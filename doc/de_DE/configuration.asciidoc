...
Die Konfiguration von Agenda-Geräten ist in dem Plugin-Menü verfügbar : 

image::../images/calendar2.PNG[]

Das sieht wie die Agenda Plugin-Seite aus(hier bereits mit 1 Gerät) : 

image::../images/calendar3.PNG[]

Sie finden hier die Liste ihrer Agenda wieder. Fals Sie auf ein Gerät klicken, erhalten Sie :

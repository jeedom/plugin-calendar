...
<div class="input-group pull-right" style="display:inline-flex">
	<span class="input-group-btn">
		<?php
		if (is_object($event)) {
			echo '<a class="btn btn-warning" id="md_eventEditDuplicate" style="color: white;"><i class="far fa-clone"></i> {{Duplication}}</a>';
		}
		?><a class="btn btn-success" id="md_eventEditSave" style="color: white;"><i class="fas fa-check-circle"></i> {{Enregistrer}}</a><?php
		if (is_object($event)) {
			echo '<a class="btn btn-danger" id="md_eventEditRemove" style="color: white;"><i class="fas fa-minus-circle"></i> {{Supprimer}}</a>';
		}
		?>
	</span>
</div>
		...
		<form class="form-horizontal">
			...
			<div role="tabpanel" class="tab-pane" id="actiontab">
				...
				<form class="form-horizontal" id="div_eventEdit">
					<fieldset>
						<legend><i class="fa fa-flag"></i> {{Début}}
							<a class="btn btn-xs btn-success bt_addAction pull-right" data-type="start" style="margin-right:10px;"><i class="fas fa-plus-circle"></i></a></legend>
							<div id="div_start"></div>
						</fieldset>
						<fieldset>
							<legend><i class="fa fa-flag-checkered"></i> {{Fin}}
								<a class="btn btn-xs btn-success bt_addAction pull-right" data-type="end" style="margin-right:10px;"><i class="fas fa-plus-circle"></i></a></legend>
								<div id="div_end"></div>
							</fieldset>
						</form>
					</div>
